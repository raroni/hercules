...
module.exports = class BundleTest extends Janitor.TestCase
  ...
  'test relative': ->
    rootDir = path.join __dirname, 'fixtures', 'relative-package'
    bundle = new Bundle rootDir
    result_in_closure = -> eval bundle.toString()
    result_in_closure.call context = {}
  ...
  'test cycling dependencies': ->
    rootDir = path.join __dirname, 'fixtures', 'circular-package'
    bundle = new Bundle rootDir
    result_in_closure = -> eval bundle.toString()
    result_in_closure.call context = {}
  ...
  'test using module as export method': ->
    rootDir = path.join __dirname, 'fixtures', 'using-module-package'
    bundle = new Bundle rootDir
    result_in_closure = -> eval bundle.toString()
    result_in_closure.call context = {}
    main = context.require './main'
  ...
  'test loading dependency from parent dir': ->
    rootDir = path.join __dirname, 'fixtures', 'parent-dependency-package'
    bundle = new Bundle rootDir
    result_in_closure = -> eval bundle.toString()
    result_in_closure.call context = {}
  ...
  'test loading package depending on nodejs package': ->
    rootDir = path.join __dirname, 'fixtures', 'node-dependency-package'
    bundle = new Bundle rootDir
  ...
  'test ignoring node packages': ->
    rootDir = path.join __dirname, 'fixtures', 'node-dependency-package'
    bundle = new Bundle rootDir, ignoreNodePackages: true
    result_in_closure = -> eval bundle.toString()
    result_in_closure.call context = {}
  ...
  'test package containing code with dollar sign followed by apostrophe': ->
    ...
    rootDir = path.join __dirname, 'fixtures', 'dollar-sign-apostrophe-package'
    bundle = new Bundle rootDir
    result_in_closure = -> eval bundle.toString()
    result_in_closure.call context = {}
    main = context.require './main'
