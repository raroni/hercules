(function() {
  var Bundle, CoffeeScript, fs, glob, path,
  ...
  module.exports = Bundle = (function() {
    ...
    Bundle.prototype.packageFiles = function() {
      return this._package_files || (this._package_files = this.buildPackageFileList());
    };

    Bundle.prototype.buildPackageFileList = function() {
      var files, glob_search_string;
    ...
    Bundle.prototype.packageFileMap = function() {
      var content, file, file_path, map, _i, _len, _ref;
      map = {};
      _ref = this.packageFiles();
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        file = _ref[_i];
        file_path = path.join(this.root_dir, file);
    ...
    Bundle.prototype.toString = function() {
      ...
      client_js = client_js.replace("'[[[package_files]]]'", JSON.stringify(this.packageFileMap()));
      return client_js;
    };
